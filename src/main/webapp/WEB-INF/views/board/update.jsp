...
$("#frm").attr("action", "/board/updateOk").submit();
}
				...
				<form method="post" id="frm" enctype="multipart/form-data">
					...
					<table border="1">
						...
						<tbody>
							<tr>
								<th scope="row">제목</th>
								<th style="backgrond: #fff;"><input type="text" name="noticeTitle" value="${list.noticeTitle}" placeholder="글 제목 입력"></th>
							</tr>
							<tr>
								<th scope="row">분류</th>
								<th style="backgrond: #fff;"><input type="text" name="noticeKind" value="${list.noticeKind}" placeholder="글 분류 입력"></th>
							</tr>
							<tr>
								<th scope="row">작성자</th>
								<th style="backgrond: #fff;"><input type="text" name="noticeWriter" value="${list.noticeWriter}" placeholder="작성자 입력"></th>
							</tr>
							<tr>
								<td colspan="2">
									<div class="detail">
										<div class="fr-view fr-view-article">
											<div class="note-editable"> 
												<textarea rows="5" cols="60" id="summernote" class="summernote" value="${list.noticeContent}" name="noticeContent">${list.noticeContent }</textarea>
											</div >
										</div>
									</div>
								</td>
					...
					<div class="ec-base-button">
						<span class="gLeft">
							...
							<input type="button" class="btn btn-primary" style="float: right;  margin-top: 10px;" onclick="aa();" value="완료" />
